...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> S.H.I.E.L.D</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> S.H.I.E.L.D </a>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                              ...
                              <input type = "submit" onclick="alert('Invoice generated Successfully');" name ="generate_bill" class = "btn btn-success" value="Generate invoice"/>
                              </a>
                              </td>
                              </form>
